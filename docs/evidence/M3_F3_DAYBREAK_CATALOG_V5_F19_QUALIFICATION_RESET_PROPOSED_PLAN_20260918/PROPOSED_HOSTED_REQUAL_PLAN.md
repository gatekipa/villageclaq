...
**Label:** F19 LOCAL CORRECTION CANDIDATE — AWAITING QA / LOCAL TX PROOF
**This document does not authorize wipe, hosted reset, credential use, Daybreak/Astra contact, or Management API apply.**

## Bound identities

- Functional tip SHA: `dfbeb11b49f7e9b061a4c700e0335d125ac669e2`
- Runtime closure label: `F19_QUALIFICATION_RESET_RUNTIME_CLOSURE`
- Runtime closure SHA-256: `8d4885d6148e7dfca99e4abdb62db6be27479731cc33e680cc36437347b6fdfe` (count 45)
- Verification-union label: `F19_QUALIFICATION_RESET_VERIFICATION_UNION`
- Verification-union SHA-256: `524a294a0202af3601db17b34a7ad72a77adaaa4cbd2e7a460089b6a4de024fa` (count 48)
...
```bash
node scripts/qualify-f3-db-push-disposable.mjs --qualification-reset --founder-authorization-artifact=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json --evidence-out=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/qualify-result.json
```

## Exact qualify-from-00118 command

```bash
node scripts/qualify-f3-db-push-disposable.mjs --no-wipe --prep-floor --sequence-f3 --floor-mode=stub-live-pin --evidence-out=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualify-from-00118/qualify-result.json
```
...
- `node scripts/qualify-f3-db-push-disposable.mjs --qualification-reset --prep-floor --founder-authorization-artifact=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json` → `F13_INVALID_FLAG_COMBINATION`
...
- Reset evidence: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/qualify-result.json`
- Founder auth artifact: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json`
- Complete qual evidence: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualify-from-00118/qualify-result.json`
- Plan record: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F19_QUALIFICATION_RESET_PROPOSED_PLAN_20260918/PROPOSED_HOSTED_REQUAL_PLAN.md`
