...
-- scopeSqlIdentitySha256 a0d09868aff25859521ae9931d14c9faa4562da11e5f872d7be8e8e1195071eb
...
SELECT pg_advisory_xact_lock(-1596942232, -1343072167);
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T1_BEGIN","event":"began"}'::text;
-- T2_LOCK
DO $f13_lock$
BEGIN
...
END
$f13_lock$;
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T2_LOCK","event":"locked"}'::text;
-- T3_REVALIDATE
DO $f13_revalidate$
DECLARE
  extra text;
...
END
$f13_revalidate$;
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T3_REVALIDATE","event":"revalidated"}'::text;
-- T4_MUTATE / T5_AFFECTED
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T4_MUTATE","event":"mutate_attempted"}'::text;
DO $f13_mutate$
DECLARE
...
END
$f13_mutate$;
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T5_AFFECTED","event":"affected_checked"}'::text;
-- T6_FINAL
DO $f13_final$
DECLARE
  leftover text;
...
END
$f13_final$;
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T6_FINAL","event":"final_ok"}'::text;
-- T7_COMMIT
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T7_COMMIT","event":"commit_attempted"}'::text;
COMMIT;
SELECT '{"schema":"f14-qualification-reset-tx-observation-v1","phase":"T7_COMMIT","event":"committed","committed":true}'::text;
