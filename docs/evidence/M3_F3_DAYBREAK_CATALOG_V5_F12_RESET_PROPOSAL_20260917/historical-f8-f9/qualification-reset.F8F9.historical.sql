-- VillageClaq EXPANDED CATALOG FINGERPRINT qualification-state reset
...
-- Restart from 00118 — do NOT resume at later versions.
-- Founder-authorized qualification reset (NOT wipe-to-baseline). DROP SCHEMA financial_core/financial_private only.
...
-- Platform ACL canary must be absent for CLEAN_BASELINE
