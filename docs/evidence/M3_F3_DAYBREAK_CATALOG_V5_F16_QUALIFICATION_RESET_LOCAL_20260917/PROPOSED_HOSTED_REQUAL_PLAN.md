...
**Label:** F16 LOCAL CORRECTION CANDIDATE — AWAITING QA / LOCAL TX PROOF
**This document does not authorize wipe, hosted reset, credential use, Daybreak/Astra contact, or Management API apply.**

## Bound identities

- Functional tip SHA: `b74c6854869acf0e826446ea0488c42469621a3b`
- Runtime closure label: `F16_QUALIFICATION_RESET_RUNTIME_CLOSURE`
- Runtime closure SHA-256: `1ca2a1ceddca278889c7ea92fc10e6a59150e06c5b4f13d4426b293fda29ee78` (count 45)
- Verification-union label: `F16_QUALIFICATION_RESET_VERIFICATION_UNION`
- Verification-union SHA-256: `989c6c99ead2b84190486b856d7e04a1e76824f870f3bbf9438935808c8fb7ff` (count 48)
...
```bash
node scripts/qualify-f3-db-push-disposable.mjs --qualification-reset --founder-authorization-artifact=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json --evidence-out=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/qualify-result.json
```

## Exact qualify-from-00118 command

```bash
node scripts/qualify-f3-db-push-disposable.mjs --no-wipe --prep-floor --sequence-f3 --floor-mode=stub-live-pin --evidence-out=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualify-from-00118/qualify-result.json
```
...
- `node scripts/qualify-f3-db-push-disposable.mjs --qualification-reset --prep-floor --founder-authorization-artifact=docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json` → `F13_INVALID_FLAG_COMBINATION`
...
- Reset evidence: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/qualify-result.json`
- Founder auth artifact: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualification-reset/FOUNDER_AUTH.json`
- Complete qual evidence: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_HOSTED_REQUAL/hosted/qualify-from-00118/qualify-result.json`
- Plan record: `docs/evidence/M3_F3_DAYBREAK_CATALOG_V5_F16_QUALIFICATION_RESET_PROPOSED_PLAN_20260917/PROPOSED_HOSTED_REQUAL_PLAN.md`
