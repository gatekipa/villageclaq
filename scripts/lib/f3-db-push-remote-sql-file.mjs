...
export function refuseDbQueryMultiStatement({ sql, fileAbsPath } = {}) {
  ...
  if (fileAbsPath) {
    ...
    if (
      ...
      /^(floor-bootstrap|floor-live-hgp|floor-live-enq|floor-live-acl|floor-stub|floor-regression|floor-cut2|floor-00117|00117_m2|floor-00030-transformed|floor-wipe|inject-)/.test(
        base,
      )
    ) {
