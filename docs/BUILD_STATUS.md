...
| **VC-03 — discarded F3 edits / deployability** | Daybreak Blue | P-003, F3-09, S0-013, high-risk matrix 11–12 | **HOLD; local upgrade mechanics advanced.** The recovered fragment remains incomplete and functional loss cannot be inferred away. Production S0/M2 schema-only catalog plus explicit 00122 prerequisite and compatibility migrations through 00145 apply in local order. History-accurate hosted rehearsal remains pending. | On the preserved isolated branch, reset only after the specific pending authorization, import the baseline and run a history-accurate 001170–00145 upgrade, effective-grant and rollback/retry checks. | [Incomplete fragment](recovery/recovered-migrations-incomplete.patch), [F24 fixture](evidence/M3_F3_DAYBREAK_CATALOG_V5_F24_HOSTED_REQUAL/hosted/qualify-from-00118/), [production-baseline upgrade](evidence/QUALIFICATION_247C8881/production-s0m2-upgrade-20260926.md), [local replay31](evidence/QUALIFICATION_247C8881/relief-agency-remittance-rollup-local-20260926.md). | `e0c10c04d4bdc287385ea1392e1aae97b458fe1c` (F24 fixture); `59459fe304dd9e593adb8088f90c3c9105405130` (local replay31 candidate). |
| **VC-04 — essential browser and hook verification** | Daybreak Blue | F3-09, H-001–H-010, F4-001–007, E-001–011, R-001–R-012, M13–M15 §31, UX-001–009, MOB-001–002; high-risk matrix 1–3, 6, 13–14 | **HOLD; representative local behavior passes, release acceptance open.** Replay31 adds non-refundable branch-agent receipt, owner recognition, maker/checker remittance, correct-grain rollup and affected dues/ticket/owner Relief/loan rechecks to prior local H/F4/E/growth probes. R-002–R-006 and R-010–R-012, hosted effective grants, and candidate-bound browser/tenant/EN/FR/mobile journeys remain unqualified. P2 French hydration remains advisory absent changed-impact evidence. | Finish remaining canonical Relief and mapped requirements; run exact candidate against the isolated branch with fictional users, suppressed outbound messaging, two-tab and mobile checks; obtain one Sol review after executor evidence. | [Prior hosted/browser result](evidence/QUALIFICATION_247C8881/representative-hosted-00137.result.md), [scope and upgrade](evidence/QUALIFICATION_247C8881/vc03-vc04-scope-and-upgrade-20260926.md), [local replay31](evidence/QUALIFICATION_247C8881/relief-agency-remittance-rollup-local-20260926.md). | `cb5581dff8bb7b9a9b990ede5509bff7d246f21b` (prior browser-tested code); `59459fe304dd9e593adb8088f90c3c9105405130` (local replay31 candidate). |
