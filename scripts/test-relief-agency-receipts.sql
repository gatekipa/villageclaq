...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    v_denied:=SQLERRM LIKE '%DELEGATED_OWNER_FUND_RECEIVABLE_INSUFFICIENT%'
      OR SQLERRM LIKE '%DELEGATED_RECOGNIZED_FUNDS_INSUFFICIENT%'; END;
  ...
  BEGIN
    PERFORM public.submit_relief_remittance(pg_catalog.jsonb_build_object(
      ...
      'account_id','00000000-0000-4000-8000-00000000e801',
      'fund_id','00000000-0000-4000-8000-00000000f802',
      'amount',16,'currency','USD','method','cash'));
  EXCEPTION WHEN OTHERS THEN
