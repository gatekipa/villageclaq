...
| **VC-03 — discarded F3 migration edits** | Daybreak Blue | P-003, F3-09, high-risk matrix 11–12 | **Evidence gap open; functional impact not demonstrated.** Incomplete loss fragment preserved. F24 passed unchanged 00118–00123 mechanics on its fixture. Representative 00137 paths pass, but clean historical replay stopped at 00032/00126 and branch-only adaptations were needed. | Prove applicable remaining approved F3 behavior with a clean full-chain candidate or record a bounded release decision; do not repeat exhausted recovery searches. | [Incomplete fragment](recovery/recovered-migrations-incomplete.patch), [F24 fixture](evidence/M3_F3_DAYBREAK_CATALOG_V5_F24_HOSTED_REQUAL/hosted/qualify-from-00118/), [hosted limitations](evidence/QUALIFICATION_247C8881/representative-hosted-00137.result.md). | `e0c10c04d4bdc287385ea1392e1aae97b458fe1c` (F24); `cb5581dff8bb7b9a9b990ede5509bff7d246f21b` (representative candidate). |
| **VC-04 — essential browser and hook verification** | Daybreak Blue | F3-09, H-008/H-010, UX-001–009, MOB-001–002; applicable high-risk matrix 1–3, 6, 13–14 | **Partly closed; release gap open.** Candidate-bound finance submission/recovery, pending/failure/success, audit display, M4 dues caller, and applicable EN/FR mobile states pass on fictional hosted data. Remaining navigation, admin, search-param, callback, phone-input, broader tenant and mobile journeys are unexecuted; fixture lacks full M15 schema. | Complete only remaining approved journeys on a suitable isolated full-chain backend. Keep Vercel Preview writes disabled until its backend is isolated and verified. | [Representative hosted/browser result](evidence/QUALIFICATION_247C8881/representative-hosted-00137.result.md), [repair report](QUALIFICATION_REPAIR_247C8881.md). | `cb5581dff8bb7b9a9b990ede5509bff7d246f21b` (tested browser code); `4f90266e9716ad11c55fce6443359a1260f9e172` (core regression). |
| **VC-05 — mandatory CI and lint classification** | Daybreak Blue; repository administrator for policy outside integration visibility | PRD §24 merge/release gates 4–5 | **Actual enforced GitHub checks: none observed; PRD acceptance remains open.** `main` unprotected, required status enforcement off with no contexts/checks, no rulesets or `.github` workflows. Detailed protection endpoint returned 403. Core repair and audit-display code pass typecheck/build; whole-repo lint has the recorded 82 errors/398 warnings baseline, and the changed dashboard retains its pre-existing `Date.now()` purity error. | Administrator/Jude confirms any policy hidden from this integration; Daybreak Blue satisfies applicable PRD acceptance. Keep inherited lint debt in one advisory backlog. | [Core exact-SHA gates](evidence/QUALIFICATION_247C8881/vc05-current-gates.result.txt), [policy read and display-code gates](evidence/QUALIFICATION_247C8881/vc05-required-policy.result.md), [repair report](QUALIFICATION_REPAIR_247C8881.md). | `4f90266e9716ad11c55fce6443359a1260f9e172` (core gates); `cb5581dff8bb7b9a9b990ede5509bff7d246f21b` (typecheck/build). |
| **VC-06 — Astra independent review access** | Astra when accessible; Daybreak Blue coordinates; Jude decides substitute | PRD §24 security review; repository independent-review cap | **Access blocker open.** Actual `gpt-6-astra` delegation returned HTTP 403 before execution; no independent round or verdict exists. No changed access condition supports an identical retry. | Enable a supported Astra path or obtain Jude's explicit reviewer-substitution decision, then review the bounded repaired candidate. | [Repair report](QUALIFICATION_REPAIR_247C8881.md) and 403 record; no independent closure evidence. | `cb5581dff8bb7b9a9b990ede5509bff7d246f21b` ready for review; none independently verified. |
...
| Essential browser journeys | The local candidate was verified against isolated Supabase branch `nisipxbuvndobyxqqglf` before fictional writes. Finance and audit EN/FR mobile paths pass in the documented fixture. Other named journeys remain for VC-04. The Vercel preview inherits production backend variables and was not used for writes. |
