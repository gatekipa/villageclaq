...
| **Next Master Milestone** | **M4 (Contributions & Dues Canonical Rebuild)** designated per Master Rebuild PRD sequence. Merge/deploy to `origin/main` remains separately founder-controlled. |
...
8. **Next Master Milestone: M4 (Contributions & Dues Canonical Rebuild)** — Designated as the next major work package per Master Rebuild PRD (`docs/VILLAGECLAQ_MASTER_REBUILD_PRD_V1.md`).
9. **Production migration release gate** — Production deployment remains separately founder-authorized.
...
|-------|-------|
| Owner | Jude Anyere |
| Next bounded action | Advance to **M4 (Contributions & Dues Canonical Rebuild)** per Master PRD sequence. |
| Permitted scope | M4 rebuild planning and implementation. No direct mutation of production. |
| Remaining acceptance | M4 contribution schedule, dues lifecycle, and payment reconciliation contracts. |
...
Next Milestone: `M4 (Contributions & Dues Canonical Rebuild)`
